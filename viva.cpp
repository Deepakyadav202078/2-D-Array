...
#include<stack>  
using namespace std;  
// defines the Boolean function for operator, operand, equal Or higher precedence and the string conversion function
...
// define the IsOperator() function to Check whether any symbol is operator.  
/* If the symbol is operator, it will returns true, otherwise false. */  
...
// IsOperand() function is used to Check whether the character is operand.  
